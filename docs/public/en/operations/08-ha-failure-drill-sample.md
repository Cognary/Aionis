...
This is a filled example based on the [HA Failure Drill Template](/public/en/operations/07-ha-failure-drill-template).
...
7. Release/tag: `core=v0.2.3`, `docker=v0.2.3`
