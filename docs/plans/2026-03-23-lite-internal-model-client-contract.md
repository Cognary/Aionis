...
4. Thread replacement hooks through runtime builder.
5. Add contract tests for custom factory replacement.
6. Verify targeted governance tests, `tsc`, and `test:lite`.
