...
|---|---|---|---|---|---|---|
| `@aionis/sdk` (TypeScript) | `0.1.x` | `/Users/lucio/Desktop/Aionis/docs/API_CONTRACT.md` (2026-02-16) | `write/recall/recallText/rulesEvaluate/toolsSelect/toolsFeedback` | `AionisApiError` + `AionisNetworkError` | yes | current |
| `aionis-sdk` (Python) | `0.1.x` | `/Users/lucio/Desktop/Aionis/docs/API_CONTRACT.md` (2026-02-17) | `write/recall/recall_text/rules_evaluate/tools_select/tools_feedback` | `AionisApiError` + `AionisNetworkError` | yes | current |
