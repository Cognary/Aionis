...
1. "What is the product model?" -> [What Aionis Is](../02-what-is-aionis)
2. "Can I get this running quickly?" -> [Quickstart](../03-how-to-use-aionis/quickstart)
3. "Is the API real enough to integrate?" -> [Endpoint Reference](../04-reference-and-operations/endpoints)
...
1. read [What Aionis Is](../02-what-is-aionis) if you need the product model
2. run [Quickstart](../03-how-to-use-aionis/quickstart) if you want the first proof fast
3. inspect [Verification Status](../04-reference-and-operations/verification-status) if you need to separate `live-verified` from `code-backed`
...
1. [What Aionis Is](../02-what-is-aionis)
2. [How To Use Aionis](../03-how-to-use-aionis)
3. [Complete Flow](../03-how-to-use-aionis/complete-flow)
4. [Reference And Operations](../04-reference-and-operations)
