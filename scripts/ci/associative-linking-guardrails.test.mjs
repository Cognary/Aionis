    ...
    const promotionCandidates = [
      {
        ...
        evidence_json: {
          source_visibility: { memory_lane: "shared", owner_agent_id: null, owner_team_id: null },
          candidate_visibility: { memory_lane: "shared", owner_agent_id: null, owner_team_id: null },
        },
